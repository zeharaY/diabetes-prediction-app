...
if st.button("Calculate Diabetes Risk"):
    try:
        # Create DataFrame with named columns (must match training data exactly)
        ...
        st.write("- The model expects the same features it was trained with")
        st.write("- Column names match exactly with training data")
